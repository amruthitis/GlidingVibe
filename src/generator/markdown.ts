...
### ✍️ Copywriting Tone: ${copyMeta?.name || brief.copyTone}
...
> ⚖️ **License Notice**: All third-party resources, components, photography, and fonts listed above remain subject to the respective provider's terms of service and license agreements. Please verify specific commercial attribution rules where applicable.
...
*Generated with ❤️ by **GlidingVibe CLI** — Turn product ideas into AI-agent-ready build briefs in seconds.*
`;
}
